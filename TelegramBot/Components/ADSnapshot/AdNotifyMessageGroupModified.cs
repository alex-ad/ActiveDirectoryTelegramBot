...
{
	/// <summary>
	///		Оповещение: группа изменена
	/// </summary>
	internal class AdNotifyMessageGroupModified : AdNotifyMessage
	{
		private AdNotifyMessageGroupModified(AdNotifyType.ChangingObjectType changingObject,
		...
		public AdNotifyMessageGroupModified(string schemeClass, string name, string property, string value) : this(
			AdNotifyType.ChangingObjectType.Group, AdNotifyType.ChangingOperationType.Modified, schemeClass, name,
			property, value)
		{
		}
	}
